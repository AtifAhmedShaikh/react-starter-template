...
import { fileDisposeSchema } from "@/schema/complaintSchema";
...
const FileComplaintModel = ({ isOpen, complaint, onClose, onSubmit }) => {
  ...
  const {
    ...
    resolver: yupResolver(fileDisposeSchema),
    defaultValues: {
      remarks: "",
      attachments: [],
    },
  ...
  const submitForm = async (data) => {
    ...
    formData.append("status", COMPLAINT_STATUS.DISPOSED);
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} title="File / Dispose Complaint">
...
export default FileComplaintModel;
