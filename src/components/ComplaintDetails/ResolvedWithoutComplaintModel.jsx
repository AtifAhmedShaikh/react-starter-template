...
import { resolvedWithoutActionSchema } from "@/schema/complaintSchema";
...
const ResolvedComplaintModel = ({ isOpen, complaint, onClose, onSubmit }) => {
  ...
  const {
    ...
    resolver: yupResolver(resolvedWithoutActionSchema),
    defaultValues: {
      remarks: "",
      attachments: [],
    },
  ...
  const submitForm = async (data) => {
    ...
    try {
      ...
      formData.append("status", COMPLAINT_STATUS.RESOLVED_NO_ACTION);
      ...
      toast.error(error.message || "Failed to send remarks");
    }
  };

  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} title="Mark as Resolved With No Action">
...
export default ResolvedComplaintModel;
