...
const ReferComplaintModal = ({ isOpen, complaint, onClose, onSubmit }) => {
  ...
  const submitForm = async (data) => {
    ...
    formData.append("status", COMPLAINT_STATUS.REFER_COMPLAINT);
    ...
    toast.success(response?.message || "Complaint referred successfully");
    dispatch(fetchDashboardData(true))
    onSubmit?.();
  };

  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} title="Refer Complaint">
...
export default ReferComplaintModal;
