...
const ComplaintFormPreview = ({ attachments = [] }) => {
    ...
    const displayedOffence = (offence?.key || "")?.toLowerCase() === "other" ? data?.otherOffence || "N/A" : offence?.value || "N/A"
    const displayedTypeOfPerson = (personType?.key || "")?.toLowerCase() === "other" ? data?.otherTypeOfPerson || "N/A" : personType?.value || "N/A"
            ...
            <div className="space-y-6 bg-white p-6 shadow-lg border rounded-md">
                ...
                <section>
                    ...
                    <div className="sm:text-lg text-sm space-y-2 mt-3">
                        ...
                        <p className="font-nastaliq"><strong>Summary:</strong> {data.summary}</p>
                            ...
                            {data.allegedPersons.map((person, index) => {
                                ...
                                return (
                                    <li key={index} className="p-4 rounded-lg shadow-sm border ">
                                        ...
                                        <p><strong>Mobile:</strong> {person.phoneNumber || <span className="text-xs">Not added</span>}</p>
